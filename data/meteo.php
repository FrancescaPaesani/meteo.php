...
<span><span class="material-icons">thermostat</span>Temp. Max: <?php echo $data->main->temp_max; ?>°F</span>
<span><span class="material-icons">thermostat</span>Temp. Min: <?php echo $data->main->temp_min; ?>°F</span>
</div>
